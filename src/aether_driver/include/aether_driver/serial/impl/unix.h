...
#define AETHER_DRIVER__IMPL__UNIX_H_
...
class aether_driver::Serial::SerialImpl {
 public:
  SerialImpl(const string &port, uint64_t baudrate, bytesize_t bytesize,
...
#endif  // AETHER_DRIVER__IMPL__UNIX_H_
