...
#include "aether_driver/serial/impl/unix.h"
...
using aether_driver::MillisecondTimer;
...
Serial::SerialImpl::SerialImpl (const string &port, uint64_t baudrate,
                                bytesize_t bytesize,
