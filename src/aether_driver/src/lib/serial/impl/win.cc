...
#include "aether_driver/serial/impl/win.h"

using std::string;
using std::wstring;
using std::stringstream;
using std::invalid_argument;
using aether_driver::Serial;
using aether_driver::Timeout;
using aether_driver::bytesize_t;
using aether_driver::parity_t;
using aether_driver::stopbits_t;
using aether_driver::flowcontrol_t;
using aether_driver::SerialException;
using aether_driver::PortNotOpenedException;
using aether_driver::IOException;
...
void
Serial::SerialImpl::setTimeout (aether_driver::Timeout &timeout)
{
  timeout_ = timeout;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setBytesize (aether_driver::bytesize_t bytesize)
{
  bytesize_ = bytesize;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setParity (aether_driver::parity_t parity)
{
  parity_ = parity;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setStopbits (aether_driver::stopbits_t stopbits)
{
  stopbits_ = stopbits;
  if (is_open_) {
    reconfigurePort ();
...
void
Serial::SerialImpl::setFlowcontrol (aether_driver::flowcontrol_t flowcontrol)
{
